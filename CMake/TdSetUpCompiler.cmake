...
function(td_set_up_compiler)
  ...
  elseif (CLANG OR GCC)
    if (NOT __vita__)
      ...
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=gnu++14 -fno-omit-frame-pointer -fno-exceptions -fno-rtti")
      set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -std=gnu11")
      add_definitions(-D_POSIX_REALTIME_SIGNALS -D__rtems__ -DSQLITE_OMIT_WAL)
    endif()
    if (APPLE)
